...
Sinon : 
  ...
  - java -jar xxxx.jar (Menu.jar ou Server.jar
  - Importer le code dans votre IDE
...
Il est possible que vous ne puissiez pas lancer plusieurs instances d'un même .jar par le double clic. Passer par la console ou votre IDE.
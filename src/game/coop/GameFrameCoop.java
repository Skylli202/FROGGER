...
public class GameFrameCoop extends JPanel implements ActionListener {

	private static final long serialVersionUID = 4L;

	static Timer mainTimer;
	static PlayerOne playerOne;
	static PlayerTwo playerTwo;
	...
	public GameFrameCoop(String username, String ipaddress, String port) {
	...
	private void drawPlayerOne(Graphics2D g2d) {
		playerOne.draw(g2d);
	}

	private void drawPlayerTwo(Graphics2D g2d) {
		playerTwo.draw(g2d);
	}
	...
	private void initPlayerOne() {
		playerOne = new PlayerOne(270, 760);
		addKeyListener(new KeyAdapt(playerOne));
	}

	private void initPlayerTwo() {
		playerTwo = new PlayerTwo(270, 45);
		addKeyListener(new KeyAdapt(playerTwo));
	}
